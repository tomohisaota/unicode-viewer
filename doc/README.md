...
| [WHATWG vs Unicode.org](./whatwg-vs-unicode-org.md) | WHATWG と Unicode.org のマッピング相違（日本語・中国語・韓国語・西欧等） |
| [CJK IVS Font](./cjk-ivs-font.md) | IVS フォント統合手順、ライセンス、トラブルシューティング |
